...
<style>
    .sidebar-gradient-redpink {
        background: linear-gradient(135deg, rgb(65, 147, 255), rgb(43, 255, 202)) !important;
        /* đỏ hồng chuyển sắc */
        color: white;
    }
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ route('nhacungcap.home.index') }}" class="nav-link">Trang chủ</a>
                </li>
        ...
        <aside class="main-sidebar elevation-4 sidebar-gradient-redpink">
            ...
            <a href="" class="brand-link">
                ...
                <span class="brand-text font-weight-light text-center">QUẢN TRỊ HỆ THỐNG <br> NHÀ CUNG CẤP</span> <br>
                <span class="brand-text font-weight-light text-center">{{ optional($user->nhanVienNhaCungCap->nhaCungCap)->ten ?? '---' }}</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <!-- Quản lý tuyển sinh -->
                        <li class="nav-header">QUẢN LÝ HỆ THỐNG CUNG CẤP</li>


                        @if ($user->nhanVienNhaCungCap->vai_tro == 'giam_doc')
                        <!-- Ngành học -->
                        <li class="nav-item">
                            <a href="{{route('nhacungcap.nguoidung.index')}}" class="nav-link">
                        ...
                        <!-- Phân mục WebQuest -->
                        <li class="nav-item">
                            <a href="{{route('nhacungcap.donnhap.index')}}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{route('nhacungcap.nguyenlieu.index')}}" class="nav-link">
