...
@section('content')
<div class="container">
    <h3>✏️ Sửa thông tin nhân viên nhà cung cấp</h3>
    ...
    <form method="POST" action="{{ route('nhacungcap.nguoidung.update', $nhanVien->id) }}">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('nhacungcap.nguoidung.index') }}" class="btn btn-secondary">⬅️ Quay lại</a>
    </form>
</div>
@endsection