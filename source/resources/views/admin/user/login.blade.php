                ...
                <div class="login-card-body">
                    ...
                    <form action="{{ route('login.store') }}" method="POST">
                        ...
                        <small class="form-text text-muted">
                            * Tên đăng nhập chỉ chứa chữ thường, số, và dấu gạch dưới (không dấu, không khoảng trắng, không chữ hoa).
                        </small>
                        ...
                        <div class="form-group form-check">
                            ...
                            <a class="small-text" href="{{ route('password.forgot') }}">- Quên mật khẩu?</a>
